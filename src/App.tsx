                    ...
                    {bestWallet ? (
                      <div className="space-y-1">
                        ...
                        <button
                          ...
                          className={`mt-2 w-full py-2.5 rounded-xl font-black text-[10px] uppercase tracking-widest transition-all active:scale-[0.98] shadow-lg ${syncingTxHash
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center justify-between p-6 bg-slate-900/50 rounded-[2rem] backdrop-blur-xl border-none">
                  ...
                  <button
                    ...
                    className={`px-6 py-3 rounded-xl text-[10px] font-bold uppercase transition-all ${isTestMode
      ...
      <AnimatePresence>
        {notifications.map((n) => (
          <motion.div
            ...
            className={`pointer-events-auto p-4 md:p-5 rounded-2xl shadow-2xl backdrop-blur-xl flex items-center gap-4 w-full max-w-[380px] md:min-w-[320px] ${n.type === 'success' ? 'bg-emerald-500/10' :
              n.type === 'error' ? 'bg-red-500/10' :
                'bg-sky-500/10'
              }`}
          >
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${n.type === 'success' ? 'bg-emerald-500 text-slate-950' :
